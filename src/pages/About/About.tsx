...
const About = () => {
  ...
  return (
    <>
     <Navigation />
    <section id="about" className="py-20 md:container md:mx-auto px-4 bg-gradient-primary relative overflow-hidden">
    
      {/* Background Effects */}
      <div className="absolute top-0 left-0 w-full h-full">
        <div className="absolute top-1/4 right-0 w-96 h-96 bg-accent opacity-5 rounded-full blur-3xl animate-float"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-slide-in-left">
            ...
            <h2 className="text-4xl md:text-5xl font-bold leading-tight">
              Creating <span className="bg-gradient-to-tr from-red-300 to-red-500 bg-clip-text text-transparent">Beautiful</span> Digital Experiences
            </h2>
